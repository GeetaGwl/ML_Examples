...
app.layout=html.Div([
    #nav wala square
    html.Nav([
        html.H1(id="logo",children="HousePrediction"),
        #ul ka div bhi hoga
    ...
    #ek aur div predicted value ko show krne ke liye
     ...
     html.Div([
         html.H2("||YOUR APPROX HOUSE PRICE||",style={'textAlign':'center','color':'#0c2461'}),html.Br(),html.Br(),
         html.Label(id="ans"),
